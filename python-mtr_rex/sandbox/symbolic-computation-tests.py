...
def gen_symbolic_expressions():
    ...
    MTR_REX = 1 / Z_lab - 1 / Z_ref
    MTR_REX_direct_ss = 1 / Z_ss_lab - 1 / Z_ss_ref
    MTR_REX_indirect_ss = -lambda_1_lab / sp.cos(theta_lab) ** 2 + lambda_1_ref / sp.cos(theta_ref) ** 2

    gen_MTR_REX = sp.lambdify(
    ...
    gen_MTR_REX_direct_ss = sp.lambdify(
        [R1a, R2a, dwa, R1b, R2b, k, f, dwb, offset, power, B0, gamma, tp],
        MTR_REX_direct_ss,
        modules="jax",
        cse=True,
    ...
    gen_MTR_REX_indirect_ss = sp.lambdify(
        [R1a, R2a, dwa, R1b, R2b, k, f, dwb, offset, power, B0, gamma, tp],
        MTR_REX_indirect_ss,
        modules="jax",
        cse=True,
    ...
    with open("src/gen_MTR_REX.py", "w") as text_file:
        text_file.write("import jax.numpy as jnp\n")
        text_file.write(inspect.getsource(gen_MTR_REX))

    filereplace("src/gen_MTR_REX.py", "_lambdifygenerated", "gen_spectrum_symbolic")
    filereplace("src/gen_MTR_REX.py", "exp", "jnp.exp")
    filereplace("src/gen_MTR_REX.py", "abs", "jnp.absolute")
    filereplace("src/gen_MTR_REX.py", "sqrt", "jnp.sqrt")

    with open("src/gen_MTR_REX_direct_ss.py", "w") as text_file:
        text_file.write("import jax.numpy as jnp\n")
        text_file.write(inspect.getsource(gen_MTR_REX_direct_ss))

    filereplace("src/gen_MTR_REX_direct_ss.py", "_lambdifygenerated", "gen_spectrum_symbolic")
    filereplace("src/gen_MTR_REX_direct_ss.py", "exp", "jnp.exp")
    filereplace("src/gen_MTR_REX_direct_ss.py", "abs", "jnp.absolute")
    filereplace("src/gen_MTR_REX_direct_ss.py", "sqrt", "jnp.sqrt")

    with open("src/gen_MTR_REX_indirect_ss.py", "w") as text_file:
        text_file.write("import jax.numpy as jnp\n")
        text_file.write(inspect.getsource(gen_MTR_REX_indirect_ss))

    filereplace("src/gen_MTR_REX_indirect_ss.py", "_lambdifygenerated", "gen_spectrum_symbolic")
    filereplace("src/gen_MTR_REX_indirect_ss.py", "exp", "jnp.exp")
    filereplace("src/gen_MTR_REX_indirect_ss.py", "abs", "jnp.absolute")
    filereplace("src/gen_MTR_REX_indirect_ss.py", "sqrt", "jnp.sqrt")
    return gen_MTR_REX, gen_MTR_REX_direct_ss, gen_MTR_REX_indirect_ss


gen_MTR_REX, gen_MTR_REX_direct_ss, gen_MTR_REX_indirect_ss = gen_symbolic_expressions()
